...
$query=sprintf("SELECT fecha,count(*) from prueba group by %s order by %s desc;",
...
?>
  <tr>
   <td><br><a id="<?php $arreglo[$cont] ?>" href="SegundaConsulta2.php?fecha=<?php echo $fecha_protegida ?>"> <?php echo fechaesp($arreglo[$cont]) ?> </a></td>
